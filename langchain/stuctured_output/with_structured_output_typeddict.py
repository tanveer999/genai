...
class Review(TypedDict):
  ...
  sentiment: Annotated[Literal["pos", "neg", "neu"], "The overall sentiment of the review (positive, negative, neutral)"]
  pros: Annotated[Optional[list[str]], "List all the pros inside a list"]
  cons: Annotated[Optional[list[str]], "List all the cons inside a list"]
  username: Annotated[Optional[str], "The username of the reviewer"]
